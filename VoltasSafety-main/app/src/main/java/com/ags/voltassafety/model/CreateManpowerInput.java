...
public class CreateManpowerInput implements Serializable {
    ...
    @Expose
    private Float injuryRateLtifrPer;
    @SerializedName("injuryRateMtifrPer")
    @Expose
    private Float injuryRateMtifrPer;
    @SerializedName("injuryRateAfrPer")
    @Expose
    private Float injuryRateAfrPer;
    ...
    public Float getInjuryRateLtifrPer() {
        return injuryRateLtifrPer;
    }

    public void setInjuryRateLtifrPer(Float injuryRateLtifrPer) {
        this.injuryRateLtifrPer = injuryRateLtifrPer;
    }

    public Float getInjuryRateMtifrPer() {
        return injuryRateMtifrPer;
    }

    public void setInjuryRateMtifrPer(Float injuryRateMtifrPer) {
        this.injuryRateMtifrPer = injuryRateMtifrPer;
    }

    public Float getInjuryRateAfrPer() {
        return injuryRateAfrPer;
    }

    public void setInjuryRateAfrPer(Float injuryRateAfrPer) {
