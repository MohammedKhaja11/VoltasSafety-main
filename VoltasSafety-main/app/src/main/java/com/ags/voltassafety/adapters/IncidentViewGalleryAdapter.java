...
public class IncidentViewGalleryAdapter extends BaseAdapter {
    private Context ctx;
    private int pos;
    ...
    public IncidentViewGalleryAdapter(Context ctx, List<ObservationAttachmentModel> mArrayUri) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View itemView = inflater.inflate(R.layout.incidentview_gallery_gv_item, parent, false);
...
//        if(strObservationID.equalsIgnoreCase("empty")){
