...
import com.ags.voltassafety.adapters.ObservationDetailPartialReportViewAdapter;
...
public class ObservationDetailsActivityForAdmin extends BaseActivity{
    ...
    ObservationDetailPartialReportViewAdapter observationDetailsAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            setContentView(R.layout.activity_observation_details_admin);
            initialisation();
            setFonts();
            toolbar_title = findViewById(R.id.toolbar_title);
            toolbar_title.setTypeface(Utilities.fontBold(ObservationDetailsActivityForAdmin.this));
            incident_information_text.setTypeface(Utilities.fontBold(ObservationDetailsActivityForAdmin.this));
            customer_information_textview.setTypeface(Utilities.fontBold(ObservationDetailsActivityForAdmin.this));
            employee_information_text.setTypeface(Utilities.fontBold(ObservationDetailsActivityForAdmin.this));
            site_engineer_information_text.setTypeface(Utilities.fontBold(ObservationDetailsActivityForAdmin.this));
            concern_engineer_information_text.setTypeface(Utilities.fontBold(ObservationDetailsActivityForAdmin.this));
            observation_header_text.setTypeface(Utilities.fontBold(ObservationDetailsActivityForAdmin.this));
            ...
            /*item_header_edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (observationHeader.getReason().equalsIgnoreCase("Hazard")) {
                        Intent itemeditintent = new Intent(ObservationDetailsActivityForAdmin.this, HazardActivity.class);
                        Bundle b = new Bundle();
                        b.putSerializable("HeaderObject", (Serializable) observationHeader);
                        itemeditintent.putExtras(b);
                        ...
                        Intent itemeditintent = new Intent(ObservationDetailsActivityForAdmin.this, NearMissActivity.class);
                        Bundle b = new Bundle();
                        b.putSerializable("HeaderObject", (Serializable) observationHeader);
                        itemeditintent.putExtras(b);
...
*/
            ...
            closeObservation.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(ObservationDetailsActivityForAdmin.this,CloseObservationActivityAdmin.class);
           ...
           /* editDetails.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (observationItemsList != null && observationItemsList.size() != 0) {
                        Intent itemeditintent = new Intent(ObservationDetailsActivityForAdmin.this, CreateObservationActivity.class);
                        Bundle b = new Bundle();
...
*/
        ...
        delete_observation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mAlertDialog = new AlertDialog.Builder(ObservationDetailsActivityForAdmin.this, R.style.MyDialogTheme);
    ...
    public void updateObservation() {
        try {
            ...
            showProgressDialog(ObservationDetailsActivityForAdmin.this);
                ...
                public void onResponse(Call<CreateResponse> call, Response<CreateResponse> response) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (loginResponse.getSuccess()) {
                            dismissProgress();
                            final AlertDialog.Builder builder = new AlertDialog.Builder(ObservationDetailsActivityForAdmin.this, R.style.MyDialogTheme);
                            builder.setTitle(getResources().getString(R.string.information))
                                    ...
                                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            Intent intent1 = new Intent(ObservationDetailsActivityForAdmin.this, ObservationViewActivityAdmin.class);
                                            if (observationHeader.getReason().equalsIgnoreCase("Hazard")) {
    ...
    private void getObservationDetails() {
        try {
            if (Utilities.isConnectingToInternet(getApplicationContext())) {
                ...
                progressDialog = new ProgressDialog(ObservationDetailsActivityForAdmin.this, R.style.MyDialogTheme);
...
//                                    SimpleDateFormat df = new SimpleDateFormat("dd-MM-yyyy HH:mm");
                                    ...
                                    observationDetailsAdapter = new ObservationDetailPartialReportViewAdapter(ObservationDetailsActivityForAdmin.this, observationItemsList, observationAttachmentsList,observationHeader);
                ...
                Utilities.showAlertDialog("Please check your internet connection", ObservationDetailsActivityForAdmin.this);
            }
        } catch (Exception e) {
            e.getMessage();
        }
...
//        Log.d("Reason", observationHeader.getReason());
        ...
        try {
            ...
            if (observationHeader.getReason().equalsIgnoreCase("Accident")) {
                itemeditintent = new Intent(ObservationDetailsActivityForAdmin.this, IncidentActivity.class);
            } else if (observationHeader.getReason().equalsIgnoreCase("Hazard")) {
                itemeditintent = new Intent(ObservationDetailsActivityForAdmin.this, HazardActivity.class);
            } else {
                itemeditintent = new Intent(ObservationDetailsActivityForAdmin.this, NearMissActivity.class);
            }
