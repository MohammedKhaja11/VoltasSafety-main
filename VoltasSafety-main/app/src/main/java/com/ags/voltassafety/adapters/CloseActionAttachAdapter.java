...
public class CloseActionAttachAdapter extends BaseAdapter {
    private Context ctx;
    private int pos;
    ...
    public CloseActionAttachAdapter(Context ctx, List<ObservationAttachmentModel> mArrayUri,String observationIdStr) {
