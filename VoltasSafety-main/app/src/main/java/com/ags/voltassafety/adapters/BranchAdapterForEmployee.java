...
import com.ags.voltassafety.CreateObservationActivityForEmployee;
...
public class BranchAdapterForEmployee extends RecyclerView.Adapter<BranchAdapterForEmployee.MyViewHolder> {
    Context context;
    ...
    public BranchAdapterForEmployee(CreateObservationActivityForEmployee createObservation, ArrayList<Customer> branchArrayList, OnItemClicked onClick) {
    ...
    @NonNull
    @Override
    public BranchAdapterForEmployee.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.branch_items, parent, false);
        BranchAdapterForEmployee.MyViewHolder vh = new BranchAdapterForEmployee.MyViewHolder(v); // pass the view to View Holder
        return vh;
    }

    @Override
    public void onBindViewHolder(@NonNull final BranchAdapterForEmployee.MyViewHolder holder, final int position) {
