...
public class SupportActivity extends Activity {
    ...
    String mStrAdminURL = "https://vsmart.voltasworld.com/USERManual/Voltas_Safety_User_Manual.pdf";

    String mStrEngURL = "https://vsmart.voltasworld.com/USERManual/Engineer_User_Manual.pdf";

    String mStrGuestURL = "https://vsmart.voltasworld.com/USERManual/Guest_User_Manual.pdf";

    String mStrUserURL = "https://vsmart.voltasworld.com/USERManual/SAFETY_User_Manual.pdf";
    File file;
    ImageView back;
...
//        tv_content.setTypeface(Utilities.fontRegular(SupportActivity.this));
        ...
        toolbar_title.setTypeface(Utilities.fontBold(SupportActivity.this));
...
//        tv_filename.setTypeface(Utilities.fontRegular(SupportActivity.this));
        ...
        back.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                Intent home = new Intent(SupportActivity.this, HomeActivity.class);
     ...
     /*   btn_save.setOnClickListener(new OnClickListener() {
        ...
        img_manual.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                //String strFlag = getIntent().getExtras().getString("strFlag");
                String LoginUserID = sharedPreferences.getString("LoginUserID", null);
                if (LoginUserID.equalsIgnoreCase("Guest")) {

                    downloadFile(mStrGuestURL);
                }
                /*else if (strFlag.equalsIgnoreCase("EmployeeNotExisted")) {

                    downloadFile(mStrUserURL);
                }*/

                else if (roleId.equalsIgnoreCase("ROLE000001") || roleId.equalsIgnoreCase("ROLE000002")|| roleId.equalsIgnoreCase("ROLE000003") || roleId.equalsIgnoreCase("ROLE000004") || roleId.equalsIgnoreCase("ROLE000005") || roleId.equalsIgnoreCase("ROLE000006")) {

                    downloadFile(mStrAdminURL);

                } else {

                    downloadFile(mStrEngURL);
                }
    ...
    public void downloadFile(String strFileURL) {
        if (Utilities.isConnectingToInternet(SupportActivity.this)) {
            ApiInterface apiInterface = RetrofitConnect.getClient().create(ApiInterface.class);
            // Set up progress before call
            final ProgressDialog progressDialog = new ProgressDialog(SupportActivity.this, R.style.MyDialogTheme);
            ...
            apiInterface.downloadFileWithDynamicUrl(strFileURL).enqueue(new Callback<ResponseBody>() {
                ...
                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (writtenToDisk) {
                            alertDialog = new AlertDialog.Builder(SupportActivity.this, R.style.MyDialogTheme);
                            alertDialog.setTitle("Information");
