...
public class DetailsViewAdapter extends BaseAdapter {
    ...
    public DetailsViewAdapter(Context ctx, List<ObservationAttachmentModel> mArrayUri) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View itemView = inflater.inflate(R.layout.details_gv_item, parent, false);
        ...
        if (mArrayUri != null && mArrayUri.size() > 0 && mArrayUri.get(position).getUrl() != null) {
