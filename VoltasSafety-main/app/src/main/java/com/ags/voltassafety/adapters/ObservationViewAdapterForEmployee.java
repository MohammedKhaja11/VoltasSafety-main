...
import com.ags.voltassafety.ObservationDetailsActivityForEmployee;
import com.ags.voltassafety.ObservationViewActivity;
import com.ags.voltassafety.ObservationViewActivityForEmployee;
...
public class ObservationViewAdapterForEmployee extends RecyclerView.Adapter<ObservationViewAdapterForEmployee.MyViewHolder> {
    ...
    public ObservationViewAdapterForEmployee(ObservationViewActivityForEmployee observationView, List<ObservationHeader> observationDataArrayList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        try {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    try {
                        Intent observationdetails = new Intent(context, ObservationDetailsActivityForEmployee.class);
