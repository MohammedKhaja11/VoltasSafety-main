...
import com.ags.voltassafety.adapters.ObservationDetailsAdapterForEmployee;
...
public class ObservationDetailsActivityForEmployee extends BaseActivity implements ObservationDetailsAdapterForEmployee.OnItemClicked {

    EditText edit_incident_date, edit_incident_time, edit_sap_number, edit_site_name, edit_address,
            edit_pf_number, edit_concern_pf_number, edit_site_engineer_email, edit_customer_name, edit_site_engineer_phone, edit_other_responsible_persons, edit_site_engineer_name, edit_email_id, edit_phone_number, employee_name, employee_id, employee_email_id, employee_phone_number;
    RecyclerView observation_items_recyclerview;
    ImageView delete_observation;
    public TextView concern_engineer_information_text;
    ObservationDetailsAdapterForEmployee observationDetailsAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            toolbar_title.setTypeface(Utilities.fontBold(ObservationDetailsActivityForEmployee.this));
            incident_information_text.setTypeface(Utilities.fontBold(ObservationDetailsActivityForEmployee.this));
            customer_information_textview.setTypeface(Utilities.fontBold(ObservationDetailsActivityForEmployee.this));
            employee_information_text.setTypeface(Utilities.fontBold(ObservationDetailsActivityForEmployee.this));
            site_engineer_information_text.setTypeface(Utilities.fontBold(ObservationDetailsActivityForEmployee.this));
            concern_engineer_information_text.setTypeface(Utilities.fontBold(ObservationDetailsActivityForEmployee.this));
            observation_header_text.setTypeface(Utilities.fontBold(ObservationDetailsActivityForEmployee.this));
...
//                obsId = bundle.getString("ObsId");
            ...
            if (observationType.equalsIgnoreCase("Hazard")) {
                ...
                observation_header_text.setText("HAZARD DETAILS(" + observationId + ")");
            }
            if (subType.equalsIgnoreCase("Accident")) {
                typeLayout.setHint("Accident ID");
                incident_information_text.setText("ACCIDENT INFORMATION");
                observation_header_text.setText("ACCIDENT DETAILS(" + observationId + ")");
            }
            if (subType.equalsIgnoreCase("Near Miss")) {
                ...
                observation_header_text.setText("NEAR MISS DETAILS(" + observationId + ")");
            }
...
//            });
            ...
            item_header_edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (observationHeader.getReason().equalsIgnoreCase("Hazard")) {
                        Intent itemeditintent = new Intent(ObservationDetailsActivityForEmployee.this, HazardActivityForEmployee.class);
                        Bundle b = new Bundle();
                        b.putSerializable("HeaderObject", (Serializable) observationHeader);
                        itemeditintent.putExtras(b);
                        ...
                        Intent itemeditintent = new Intent(ObservationDetailsActivityForEmployee.this, NearMissActivityForEmployee.class);
                        Bundle b = new Bundle();
                        b.putSerializable("HeaderObject", (Serializable) observationHeader);
                        itemeditintent.putExtras(b);
            ...
            closeObservation.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(ObservationDetailsActivityForEmployee.this, ClosedActionItemActivity.class);
//                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            ...
            editDetails.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (observationItemsList != null && observationItemsList.size() != 0) {
                        Intent itemeditintent = new Intent(ObservationDetailsActivityForEmployee.this, CreateObservationActivityForEmployee.class);
                        Bundle b = new Bundle();
        ...
        delete_observation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mAlertDialog = new AlertDialog.Builder(ObservationDetailsActivityForEmployee.this, R.style.MyDialogTheme);
    ...
    public void updateObservation() {
        try {
            ...
            showProgressDialog(ObservationDetailsActivityForEmployee.this);
                ...
                public void onResponse(Call<CreateResponse> call, Response<CreateResponse> response) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (loginResponse.getSuccess()) {
                            dismissProgress();
                            final AlertDialog.Builder builder = new AlertDialog.Builder(ObservationDetailsActivityForEmployee.this, R.style.MyDialogTheme);
                            builder.setTitle(getResources().getString(R.string.information))
                                    ...
                                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            Intent intent1 = new Intent(ObservationDetailsActivityForEmployee.this, ObservationViewActivityForEmployee.class);
                                            if (observationHeader.getReason().equalsIgnoreCase("Hazard")) {
    ...
    private void getObservationDetails() {
        try {
            if (Utilities.isConnectingToInternet(getApplicationContext())) {
                ...
                progressDialog = new ProgressDialog(ObservationDetailsActivityForEmployee.this, R.style.MyDialogTheme);
                            ...
                            if (response.body().getResult() != null) {
                                ...
                                if (observationDetailsResponse.getSuccess()) {
                                    ...
                                    if (observationHeader.getReason().equalsIgnoreCase("Near Miss")) {
                                        ...
                                        toolbar_title.setText(observationHeader.getReason().toUpperCase() + " DETAILS");
                                        ...
                                        toolbar_title.setText("ACCIDENT DETAILS");
                                    }
...
//                                    SimpleDateFormat df = new SimpleDateFormat("dd-MM-yyyy HH:mm");
                                    ...
                                    observationDetailsAdapter = new ObservationDetailsAdapterForEmployee(ObservationDetailsActivityForEmployee.this, observationItemsList, observationAttachmentsList, ObservationDetailsActivityForEmployee.this, observationHeader);
                ...
                Utilities.showAlertDialog("Please check your internet connection", ObservationDetailsActivityForEmployee.this);
            }
        } catch (Exception e) {
            e.getMessage();
        }
...
//        Log.d("Reason", observationHeader.getReason());
        ...
        try {
            ...
            if (observationHeader.getReason().equalsIgnoreCase("Accident")) {
                itemeditintent = new Intent(ObservationDetailsActivityForEmployee.this, IncidentActivityForEmployee.class);
            } else if (observationHeader.getReason().equalsIgnoreCase("Hazard")) {
                itemeditintent = new Intent(ObservationDetailsActivityForEmployee.this, HazardActivityForEmployee.class);
            } else {
                itemeditintent = new Intent(ObservationDetailsActivityForEmployee.this, NearMissActivityForEmployee.class);
            }
