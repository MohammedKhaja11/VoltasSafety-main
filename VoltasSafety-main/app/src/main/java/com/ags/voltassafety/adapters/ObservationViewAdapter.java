...
public class ObservationViewAdapter extends RecyclerView.Adapter<ObservationViewAdapter.MyViewHolder> {
    ...
    public ObservationViewAdapter(ObservationViewActivity observationView, List<ObservationHeader> observationDataArrayList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        try {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    try {
                        Intent observationdetails = new Intent(context, ObservationDetailsActivity.class);
