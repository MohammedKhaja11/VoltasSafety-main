...
public class ReportsZoneAdapter  extends RecyclerView.Adapter<ReportsBranchAdapter.ViewHolder> {

    public List<UserZones> item_list;
    Context context;
    public List<UserZones> filteritems;

    public ReportsZoneAdapter(ReportsView activity, List<UserZones> zonesList) {
        context = activity;
        item_list = zonesList;
    ...
    @Override
    public ReportsBranchAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.spinner_items, null);

        // create ViewHolder
        ReportsBranchAdapter.ViewHolder viewHolder = new ReportsBranchAdapter.ViewHolder(view);

        return viewHolder;
    }

    @Override
    public void onBindViewHolder(final ReportsBranchAdapter.ViewHolder holder, final int position) {
